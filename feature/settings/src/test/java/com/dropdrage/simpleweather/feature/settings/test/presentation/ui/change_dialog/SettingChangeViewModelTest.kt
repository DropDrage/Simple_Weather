...
internal class SettingChangeViewModelTest {
    ...
    inner class changeTargetSetting {
        ...
        @Test
        fun `returns title and empty list`() = runTestViewModelScopeAndTurbine { backgroundScope ->
            val title = "Title"
        ...
        @Test
        fun `returns title and filled list`() = runTestViewModelScopeAndTurbine { backgroundScope ->
            val title = "Title"
