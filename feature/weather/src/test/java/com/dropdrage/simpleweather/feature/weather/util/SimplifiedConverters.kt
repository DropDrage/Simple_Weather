...
internal fun toViewCurrentDayWeather(currentDayWeather: DayWeather) = ViewCurrentDayWeather(
    ...
    sunriseTime = currentDayWeather.sunrise,
    sunsetTime = currentDayWeather.sunset,
    sunriseFormatted = currentDayWeather.sunrise.toString(),
    sunsetFormatted = currentDayWeather.sunset.toString(),
)
