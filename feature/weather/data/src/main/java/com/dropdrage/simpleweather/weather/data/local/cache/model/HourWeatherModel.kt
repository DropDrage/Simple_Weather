package com.dropdrage.simpleweather.weather.data.local.cache.model
...
import com.dropdrage.simpleweather.weather.data.local.cache.model.HourWeatherModel.Companion.DAY_ID_FIELD
import java.time.LocalDateTime

private const val DATE_TIME_FIELD = "date_time"

@Entity(
    indices = [Index(DATE_TIME_FIELD, DAY_ID_FIELD, unique = true), Index(DAY_ID_FIELD)],
...
internal data class HourWeatherModel(
