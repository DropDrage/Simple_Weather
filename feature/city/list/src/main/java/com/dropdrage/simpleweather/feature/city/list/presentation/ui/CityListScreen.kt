package com.dropdrage.simpleweatherfeature.city_list.presentation.ui
...
import com.dropdrage.simpleweather.feature.city.list.presentation.ui.CityListViewModel
import com.dropdrage.simpleweatherfeature.city_list.presentation.utils.swap
...
fun CityListScreen(openSearchScreen: () -> Unit) {
    ...
    val citiesCurrentWeather = remember { mutableStateListOf<ViewCityCurrentWeather>() }
    ...
    Scaffold(
        ...
        DragDropList(
            ...
            CityItemWithDropdown(
                ...
                onDeleteClicked = { viewModel.deleteCity(item) },
